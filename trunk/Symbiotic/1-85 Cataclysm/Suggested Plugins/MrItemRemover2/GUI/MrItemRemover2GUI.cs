...
namespace MrItemRemover2.GUI
{
    public partial class MrItemRemover2GUI : Form
    {
        ...
        private string refreshImangePathName = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, string.Format(@"D:/My HB Main/My Plugins/MrItemRemover2/ref.bmp"));
        private string GoldImangePathName = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, string.Format(@"D:/My HB Main/My Plugins/MrItemRemover2/Gold2.bmp"));
